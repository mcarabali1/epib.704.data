...
#'   \item{`Obesity`}{One characteristic, binary, not included in the original data shared and created from the information provided in the dataset on BMI and WHO criteria of obesity when BMI>=30}
#'   #'   \item{`comorb.bin`}{One characteristic, binary, not included in the original data shared and created for presence of any Cardiometabolic Comorbidies (ie., Obesity, Hypertension and Diabetes)}
#'   \item{`Comorbidities`}{One characteristic, categorical, not included in the original data shared and created for the Number of Cardiometabolic Comorbidies among any of Obesity, Hypertension and Diabetes in the datasset}
#' }
