...
#'   \item{`Sex`}{One characteristic, binary, not included in the original data shared and created from the information provided in the published manuscript}  
#'   \item{`GCS_severity`}{One characteristic, categorical, not included in the original data shared and created from the information provided in the published manuscript }
#' }
