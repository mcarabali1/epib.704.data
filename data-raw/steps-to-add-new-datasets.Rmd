...
6. Verify all data sets made it in your package by loading the package (Build pane > Click More > Load All or in the console using devtools::load_all()). And then call your dataset (e.g., births, it should be in the environment, not needed as data, it is just loaded)
